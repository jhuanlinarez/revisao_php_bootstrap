...
if (!empty($pagina)) {
    ...
    $query_usuarios = $conn->prepare($query_usuarios);
    ...
    if(($result_usuarios) and ($result_usuarios->rowCount() != 0)) {
        ...
        //Paginacao - Somar a quantidade de registros que há BD
...
$retorna = ['status' => true, 'dados' => $dados, 'quantidade_pg' => $quantidade_pg];
        ...
        $retorna = [false, 'msg' => "<p style='color: #f00;'>Erro: Nenhum usúario encontrado!</p>"];
    }
}else{
    $retorna = ['status' => false, 'msg' => "<p style='color: #f00;'>Erro: Nenhum usúario encontrado!</p>"];
}
